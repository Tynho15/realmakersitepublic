...
const Landing = () => {
  ...
  return(
    <div className="flex relative flex-col items-center justify-center h-screen bg-neutral-950">
      ...
      <iframe
        className="absolute opacity-50 inset-0 w-full h-full object-cover pointer-events-none"
        src="https://www.youtube.com/embed/NILtTocqZ84?autoplay=1&mute=1&loop=1&playlist=NILtTocqZ84&controls=0&showinfo=0&modestbranding=1"
